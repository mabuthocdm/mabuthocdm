...
const Footer = () => {
  ...
  const quickLinks = [
    "About Us", "Services", "Team", "Portfolio", "Blog", "Careers"
  ];

  const services = [
    "Web Development", "UI/UX Design", "Data Analytics", "Digital Strategy", "Cybersecurity", "Support"
  ];
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">hello@organization.com</span>
              </div>
            </div>
          </div>
        </div>
